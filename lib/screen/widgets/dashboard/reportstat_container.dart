...
class ReportStatContainer extends StatefulWidget {
  final List<Menu>? favoritesMenu;
  final Function(Menu menu)? onFavoriteMenuTap;
  final bool showMenu;

  const ReportStatContainer(
      {Key? key,
      this.favoritesMenu,
  ...
  @override
  State<ReportStatContainer> createState() => _ReportStatContainerState();
}

class _ReportStatContainerState extends State<ReportStatContainer>
    with AutomaticKeepAliveClientMixin<ReportStatContainer> {
