...
class ReminderListState extends State<ReminderList> {
  ...
  loadReminders({bool? refresh}) {
    var bloc = BlocProvider.of<ServerDataBloc<MachineReminder>>(context);
  ...
  Widget _reminderList() {
    return BlocListener<ServerDataBloc<MachineReminder>,
            ServerDataState<MachineReminder>>(
        listener: (BuildContext context, ServerDataState state) {
      if (state is ServerDataLoaded) {
        if (state.items != null && state.items is List<MachineReminder>) {
          List<MachineReminder> machineReminders =
              state.items as List<MachineReminder>;
    ...
    }, child: BlocBuilder<ServerDataBloc<MachineReminder>,
                ServerDataState<MachineReminder>>(
                          ...
                          body: MultiBlocProvider(
                              providers: [
                                BlocProvider.value(
                                  value:
                                  BlocProvider.of<
                                      ServerDataBloc<MachineReminder>>(context),
                                ),
                              ],
                              child: const Padding(
