...
class TextAnimationEx extends StatefulWidget {
  final String text;
  ...
  @override
  TextAnimationExState createState() => TextAnimationExState();
}

class TextAnimationExState extends State<TextAnimationEx>
  ...
  void handleTimeout(timer) {
    ...
    setState(() {
      ...
      if (assetsLoaded) {
        ...
        renderedText = renderTextWithFont(fontAssets[asset], toRender);
      }
    });
  }
...
/*Widget widgetEffect(Widget child) {
    return DecoratedBox(
        decoration: BoxDecoration(
          image:
