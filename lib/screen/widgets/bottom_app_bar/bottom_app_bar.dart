...
class BottomAppBarMulti extends StatefulWidget {
...
class _BottomAppBarState extends State<BottomAppBarMulti> {
    ...
    return SizedBox(
      ...
      child: PhysicalShape(
        ...
        child: Material(
          ...
          child: child == null ? null : SafeArea(child: child),
        ),
      ),
    );
  }
