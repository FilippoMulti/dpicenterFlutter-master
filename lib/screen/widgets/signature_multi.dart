...
///la libreria originale da cui ho fatto il fork è la seguente
///https://pub.dev/packages/signature versione 5.0.0
///Ho esposto la proprietà decoration del container cosi da poter customizzare il campo della firma
    ...
    final GestureDetector signatureCanvas = GestureDetector(
      ...
      child: Container(
        decoration: widget.decoration ??
            BoxDecoration(color: widget.backgroundColor ?? Colors.grey),
        child: Listener(
...
class SignatureController extends ValueNotifier<List<Point>> {
  ...
  Uint8List? _toPngBytesForWeb() {
    ...
    final int pColor = img.rgbaToUint32(
      penColor.red,
      penColor.green,
      penColor.blue,
      penColor.alpha,
    ...
    final int bColor = img.rgbaToUint32(
        backgroundColor.red,
    ...
    img.fill(signatureImage, color: img.ColorInt32(bColor));
