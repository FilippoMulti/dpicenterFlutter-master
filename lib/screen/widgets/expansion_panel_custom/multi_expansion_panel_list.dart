...
///  * <https://material.io/design/components/lists.html#types>
class MultiExpansionPanelList extends StatefulWidget {
  /// Creates an expansion panel list widget. The [expansionCallback] is
  /// triggered when an expansion panel expand/collapse button is pushed.
  ///
  /// The [children] and [animationDuration] arguments must not be null.
  const MultiExpansionPanelList({
    super.key,
    this.children = const <MultiExpansionPanel>[],
  ...
  /// {@end-tool}
  const MultiExpansionPanelList.radio({
    super.key,
    this.children = const <MultiExpansionPanelRadio>[],
    this.expansionCallback,
    this.animationDuration = kThemeAnimationDuration,
  ...
  /// fashion to [ListBody].
  final List<MultiExpansionPanel> children;
  ...
  @override
  State<StatefulWidget> createState() => _MultiExpansionPanelListState();
}

class _MultiExpansionPanelListState extends State<MultiExpansionPanelList> {
  MultiExpansionPanelRadio? _currentOpenPanel;
    ...
    if (widget._allowOnlyOnePanelOpen) {
      ...
      if (widget.initialOpenPanelValue != null) {
        _currentOpenPanel = searchPanelByValue(
            widget.children.cast<MultiExpansionPanelRadio>(),
  ...
  @override
  void didUpdateWidget(MultiExpansionPanelList oldWidget) {
  ...
  bool _allIdentifiersUnique() {
    ...
    for (final MultiExpansionPanelRadio child
        in widget.children.cast<MultiExpansionPanelRadio>()) {
  ...
  bool _isChildExpanded(int index) {
    if (widget._allowOnlyOnePanelOpen) {
      final MultiExpansionPanelRadio radioWidget =
          widget.children[index] as MultiExpansionPanelRadio;
  ...
  void _handlePressed(bool isExpanded, int index) {
    ...
    if (widget._allowOnlyOnePanelOpen) {
      final MultiExpansionPanelRadio pressedChild =
          widget.children[index] as MultiExpansionPanelRadio;
      ...
      for (int childIndex = 0;
          ...
          childIndex += 1) {
        final MultiExpansionPanelRadio child =
            widget.children[childIndex] as MultiExpansionPanelRadio;
  ...
  MultiExpansionPanelRadio? searchPanelByValue(
      List<MultiExpansionPanelRadio> panels, Object? value) {
    for (final MultiExpansionPanelRadio panel in panels) {
  ...
  Widget build(BuildContext context) {
    ...
    for (int index = 0; index < widget.children.length; index += 1) {
      ...
      final MultiExpansionPanel child = widget.children[index];
