...
//library date_time_picker_multi;
...
class _DateTimePickerState extends FormFieldState<String> {
  ...
  Future<void> _showDatePickerDialog() async {
      ...
      builder: (context, child) {
        return Theme(
          data: Theme.of(context).copyWith(
              dialogBackgroundColor: getAppBackgroundColor(context),
              colorScheme: Theme.of(context)
                  .colorScheme
                  .copyWith(surface: getAppBackgroundColor(context))),
          child: child!,
        );
      },
    );
    ...
    if (ldDatePicked != null) {
      ...
      _dDate = ldDatePicked;
      final lsOldValue = widget.controller?.text ?? _sValue;
      _sValue = _sDate;
