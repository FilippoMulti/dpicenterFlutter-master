...
///MIlos: 07/12/2021
///ho modificato il border di InkWell per ottenere un bordo arrotondato
///Si raccomanda di tornare alla versione originale non appena sarà possibile ottenere lo stesso risultato
...
class _TabBarState extends State<TabBar> {
  ...
  void _initIndicatorPainter() {
    ...
    _indicatorPainter = !_controllerIsValid
        ...
        : _IndicatorPainter(
            ...
            indicatorSize: indicatorSize as TabBarIndicatorSize,
  ...
  Widget build(BuildContext context) {
    ...
    for (int index = 0; index < tabCount; index += 1) {
      ///aggiunto padding per separare le schede
