...
class LoadingScreen2 extends StatefulWidget {
  ...
  @override
  LoadingScreen2State createState() {
    return LoadingScreen2State();
  }
}

// Define a corresponding State class.
// This class holds data related to the form.
class LoadingScreen2State extends State<LoadingScreen2> {
  @override
  Widget build(BuildContext context) {
    ...
    return Container(
        ...
        child: Center(
          child: (mediaData.size.height < tinyHeight &&
                      mediaData.size.width > tinyWidth) ||
              ...
              ? Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                  Padding(
                      ...
                      child: text(
                          fontSize: mediaData.size.height < tinyHeight &&
                                  mediaData.size.width < tinyWidth
                              ? 14
                              : null)),
                  pacman(
                      color: Theme.of(context).colorScheme.primary,
                      size: mediaData.size.height < tinyHeight &&
                              mediaData.size.width < tinyWidth
                          ? 50
                          : null),
                ])
